...
const Hero = ({ biddata }) => {
  ...
  return (
    <section className="flex md:flex-col lg:flex-col pt-[6%] pl-[11%] md:pt-[32%] md:pl-[20%] lg:pt-[20%] lg:pl-[9vh]">
      <div>
        <div className="flex justify-between w-[120vh] md:w-[10vh] lg:w-[53vh]">
          <div>
      ...
      <div>
        <div className="flex justify-between w-[65vh] md:w-[20vh] lg:w-[53vh] ml-4 md:mt-4 md:ml-2 lg:ml-0 lg:mt-6">
          <div>
