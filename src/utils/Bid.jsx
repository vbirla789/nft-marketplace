    ...
    <div key={id} className="">
      <div className="mt-4 mr-5 relative md:mt-8 lg:mt-8">
        <img
          src={img}
          alt="bid img"
          className="rounded-xl w-[58vh] md:w-[32vh] lg:w-[38vh]"
        />
      </div>
      <div
        className={` ${
          id == 2
            ? "md:top-[54vh] lg:top-[57vh]"
      ...
      >
        ...
        <div>
          <button className="bg-[#090D2F] w-[50vh] md:w-[30vh] lg:w-[35vh] mt-2 rounded-md text-sm font-normal py-1.5">
            {btn}
          </button>
        </div>
      </div>
