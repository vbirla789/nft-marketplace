...
const Wallet = ({ graph }) => {
  return (
    <div className="bg-gradient-to-r from-[#2E409C] to-[#080B2A] mt-4 rounded-xl w-[58vh] h-auto md:w-[33vh] md:h-[25vh] lg:w-[53vh] lg:h-auto lg:ml-0 md:ml-0 ml-8 text-[#fff]">
      <div className="px-2">
